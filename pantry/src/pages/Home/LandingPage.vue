...
import { ArrowRight, Star, Clock, ChefHat, Utensils, Flame, Leaf, ShieldCheck } from 'lucide-vue-next'
...
const features = [
  ...
  },
  {
    ...
    desc: 'Hundreds of authentic Ghanaian and West African recipes built in — from Fufu to Jollof, all at your fingertips.',
    color: '#E8591A',
    bg: '#fef0ea',
  },
  {
...
import { CalendarDays, ShoppingBasket } from 'lucide-vue-next'
</script>
    ...
    <div class="container relative z-10">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div :class="visible ? 'animate-fade-up' : 'opacity-0'">
          ...
          <h1 class="text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight" style="font-family:var(--font-display); color:var(--color-text)">
            Plan meals
            <span style="color:var(--color-primary)"> the
            <br>West African</span>
            way.
          </h1>
          ...
          <div class="flex flex-wrap gap-6">
            <div v-for="stat in stats" :key="stat.value" class="text-center md:text-left">
        ...
        <!-- Right visual — big bowl with orbiting items -->
        <div class="relative flex items-center justify-center" :class="visible ? 'animate-scale-in delay-300' : 'opacity-0'">
          <div class="relative w-72 h-72 md:w-96 md:h-96">
            ...
            <div class="absolute inset-6 food-blob-anim flex items-center justify-center text-8xl shadow-2xl"
              style="background: linear-gradient(135deg, var(--color-primary-soft), var(--color-surface-raised))">
              🍲
            </div>
            <!-- Orbit items -->
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        ]" :key="i" class="text-center animate-fade-up" :class="`delay-${(i+1)*200}`">
